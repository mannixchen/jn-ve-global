 ...
 * @LastEditTime: 2023-11-30 17:04:37
 * @FilePath: /@jsjn-librar-monorepo/jn-ve-global/scripts/build/index.ts
 * @Description: gulp 启动任务流
 */
import { parallel, series } from 'gulp'
import { buildModules, clean, generateTypes, buildFull, generateGlobalTypes } from './task'

export default series(
    clean,
    parallel(buildModules, buildFull),
    parallel(generateTypes, generateGlobalTypes)
)
